...
export class PagamentoController {
    async createPagamento(req: Request, res: Response){
        ...
        const { datahorapagamento, valorTotal, meioPagamento, valores_id } = req.body
        // Passa informações capturadas para o service
        const result = await service.createPagamento({datahorapagamento, valorTotal, meioPagamento, valores_id})
