...
export class PerfilController {
    async createPerfil(req: Request, res: Response){
        ...
        const { descricao,  criar_usuario, editar_usuario, excluir_usuario, ler_boolean } = req.body
        // Passa informações capturadas para o service
        const result = await service.createPerfil({descricao,  criar_usuario, editar_usuario, excluir_usuario, ler_boolean})
