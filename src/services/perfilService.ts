...
export class PerfilService {
    async createPerfil({ descricao,  criar_usuario, editar_usuario, excluir_usuario, ler_boolean} : newPerfilRequest) : Promise<Perfil | Error> {
        try {
            // INSERT INTO Perfils VALUES(description, date_Perfil)
            const perfil = cursor.create({
                descricao,  criar_usuario, editar_usuario, excluir_usuario, ler_boolean
            })
